subroutine read_params
  ...
  namelist/run_params/clumpfind,cosmo,pic,sink,lightcone,poisson,hydro,rt,verbose,debug &
       ...
       & ,bisec_tol,static,geom,overload,cost_weighting,aton,ray
  ...
  namelist/ray_params/ray_epsilon,ray_Nx,ray_Ny,ray_opening_x,ray_opening_y,ray_cof_x &
       & ,ray_cof_y,ray_x_obs,ray_y_obs,ray_z_obs,ray_Lbox,ray_no_bending,ray_z_s  &
       & ,ray_step_test,ray_stop_after_raytracing &
       & ,ray_do_kappa,ray_kappa_method,ray_do_shear &
       ! Start: Sownak - ISW (26/10/2015)
       & ,ray_do_isw &
       ! End: Sownak
       & ,ray_do_ngp & !ALEX-21-02-2016
       & ,ray_multi_out,ray_afresh,ray_nout,ray_zout               ! BAOJIU-17-02-2016
