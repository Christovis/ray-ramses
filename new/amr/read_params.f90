subroutine read_params
  ...
  namelist/ray_params/ray_epsilon                                                       &
       & ,ray_Nx,ray_Ny                                                                 &
       & ,ray_opening_x,ray_opening_y                                                   &
       & ,ray_cof_x,ray_cof_y,ray_x_obs                                                 &
       & ,ray_y_obs,ray_z_obs,ray_Lbox                                                  &
       & ,ray_no_bending                                                                &
       & ,ray_z_s                                                                       &
       & ,ray_step_test,ray_stop_after_raytracing                                       &
       & ,ray_do_kappa,ray_kappa_method                                                 &
       & ,ray_do_shear                                                                  &
       & ,ray_do_deflt                                                                  &
       & ,ray_do_iswrs                                                                  &
       & ,ray_do_ngp                                                                    &
       & ,ray_multi_out,ray_afresh,ray_nout,ray_zout 
